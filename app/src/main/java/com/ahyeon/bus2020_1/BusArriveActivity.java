...
public class BusArriveActivity extends AppCompatActivity {
    private static final String TAG = "##BusArriveActivity##";   //태그변수
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_arrive);
        ...
        refreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                getBusArrive(url_val, strBusStopName, strBusStopArsId);
...
//        Button bt = (Button)findViewById(R.id.btBack22);
...
//        });
    ...
    public void getBusArrive(String url_arrive, final String seletedBusstop, final String selectedArsId){
                        ...
                        try {
                            ...
                            if(array_ARRIVE_LIST.length() == 0){
                                ...
                                for(int i=0 ; i <array_ARRIVE_LIST.length();i++){     //받은 response을 BusData class로 분류
                                    ...
                                    busData.setSeleted_busstop_name(seletedBusstop);    //누른 버스정류장 이름을 넣어두고
                                    busData.setSeleted_Ars_id(selectedArsId);
                                    busDataArrayList.add(busData);
                                }
                            }

                            // Display the first 500 characters of the response string.
                            mAdapter = new BusArriveAdapter(busDataArrayList);
